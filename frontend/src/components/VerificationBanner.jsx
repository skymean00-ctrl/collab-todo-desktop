...
export default function VerificationBanner() {
  ...
  return (
    <div className="bg-amber-50 border-b border-amber-200 px-4 py-2.5 flex items-center justify-between text-sm">
      ...
      {sent ? (
        <span className="text-green-700 font-medium ml-4 flex-shrink-0">재발송 완료</span>
      ) : (
        <button
          onClick={resend}
          disabled={loading}
          className="ml-4 flex-shrink-0 text-amber-700 underline hover:text-amber-900 font-medium disabled:opacity-50"
        >
