...
; 설치 위치 설정
; 기본값: Program Files 또는 사용자 디렉토리
DefaultDirName={autopf}\{#AppName}
; 사용자가 설치 위치를 변경할 수 있도록 허용
AllowRootDirectory=no
DisableDirPage=no
; 사용자가 Program Files 외부에도 설치 가능
AllowUNCPath=no
...
begin
  ...
  begin
    ...
    // MsgBox('설치가 완료되었습니다.' + #13#10 + '설치 위치: ' + ExpandConstant('{app}'), mbInformation, MB_OK);
  end;
end;
